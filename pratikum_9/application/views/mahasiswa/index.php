    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">View Form Mahasiswa</h3>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="tgl_lahir" name="tgl_lahir" type="date" class="form-control" value="">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="tmp_lahir" name="tmp_lahir" type="text" class="form-control" value="">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <select id="prodi" name="prodi" class="custom-select">
        ...
        <option value="Bisnis Digital">Basis Digital</option>
      </select>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="ipk" name="ipk" type="text" class="form-control" value="">
      </div>
    </div>
  </div>
  <div class="form-group row">
...
<?php echo form_close();?>
    ...
    <tbody>
        <?php
            ...
            echo '<td>'.$mhs -> tmp_lahir.'</td>';
            echo '<td>'.$mhs -> nim.'</td>';
            echo '<td>'.$mhs -> nama.'</td>';
            echo '<td>'.$mhs -> gender.'</td>';
            echo '<td>'.$mhs -> prodi.'</td>';
            echo '<td>'.$mhs -> ipk.'</td>';
            echo '<td>'.$mhs -> predikat().'</td> </tr>';
            $nomor++;
            }
        ?>
    </tbody>
